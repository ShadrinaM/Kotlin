...
private const val ARG_GROUP = "group_param"
class StudentsListFragment : Fragment() {
    companion object {
        @JvmStatic
        fun newInstance(group: Group) = StudentsListFragment().apply{
            arguments = Bundle().apply {
                putString(ARG_GROUP, Gson().toJson(group))
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val groupJson = arguments?.getString(ARG_GROUP) ?: return
    ...
    private inner class StudentAdapter(private var items: List<Student>)
        ...
        fun updateStudents(newItems: List<Student>) {
            items = newItems
