...
import com.example.list.databinding.FragmentStudentListBinding
import com.example.list.interfaces.MainActivityCallbacks
import com.example.list.view_models.StudentListViewModel
import kotlinx.coroutines.DelicateCoroutinesApi
import kotlinx.coroutines.MainScope
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

// предназначен для отображения списка студента
class StudentListFragment : Fragment() {

    companion object {
        private lateinit var group: Group
        fun newInstance(group: Group) : StudentListFragment{
            this.group = group
    ...
    private fun deleteDialog(){
        AlertDialog.Builder(requireContext())
            ...
            .setMessage("Вы действительно хотите вдалить студента ${viewModel.student?.shortName ?: ""}?")
        ...
        private inner class ItemHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            fun bind(student: Student) {
                ...
                itemView.findViewById<ImageButton>(R.id.ibDeleteStudent).setOnClickListener {
                    AlertDialog.Builder(requireContext())
                        .setTitle("Удаление!")
                        .setMessage("Вы действительно хотите удалить студента ${student.shortName}")
                        .setPositiveButton("ДА") { _, _ ->
                            viewModel.deleteStudent()
                        }
                        .setNegativeButton("НЕТ", null)
